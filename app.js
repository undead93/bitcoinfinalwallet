/**
 * BitcoinFinal Wallet by Syafiq Det, Main app.js
 * Module dependencies.
 */
...
app.listen(app.get('port'), () => {
  console.log('%s BitcoinFinal Wallet is running at http://localhost:%d in %s mode', chalk.green('✓'), app.get('port'), app.get('env')); 
