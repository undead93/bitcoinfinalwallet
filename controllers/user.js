...
exports.getAccount = (req, res) => {
      ...
      if(req.user.secret) {
        var qrData = sprintf('otpauth://totp/%s?secret=%s', 'BitcoinFinal Wallet: '+req.user.email, key);
...
exports.postReset = (req, res, next) => {
  ...
  const sendResetPasswordEmail = (user) => {
    ...
    const mailOptions = {
      to: user.email,
      from: 'no-reply@bitcoinfinal.net',
      subject: 'Your btcfwallet password has been changed',
...
exports.postForgot = (req, res, next) => {
  ...
  const sendForgotPasswordEmail = (user) => {
    ...
    const mailOptions = {
      to: user.email,
      from: 'no-reply@btcfwallet.net',
      subject: 'Reset your password on btcfwallet.net',
